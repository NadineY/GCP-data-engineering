...
#mofication des type de données (object --> datetime)
    ...
    # mapping
    payment_type_dim['payment_type_name'] = payment_type_dim['payment_type'].map(payement_type_name)
    # Ordonner les colonnes
